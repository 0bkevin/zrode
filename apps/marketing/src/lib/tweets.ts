...
export const tweets = [
  {
    ...
    content:
      "Zrode is not perfect, but it's damn good. Open and fun , I can make my own fork for my uses and use the great tooling with my own needs.",
  ...
  },
  {
    ...
    content: "might say alpha but Zrode is pretty awesome, really fast too",
  ...
  },
  {
    handle: "Josikinz",
    content:
      "Zrode is better because it’s like if the codex Mac app didn’t make my computer run like shit 😋",
    link: "https://x.com/Josikinz/status/2030367951694745870",
  },
  {
    handle: "jetpackjoe_",
    content: "Zrode is pretty alright I guess",
    link: "https://x.com/jetpackjoe_/status/2054666792933404959",
  },
  {
    handle: "mil000",
    content: "Zrode saved my relationship!",
  ...
  {
    handle: "uwunetes",
    content: "claude code make me go *whine whine whine* and zrode make me go woof woof awooooo!!!",
