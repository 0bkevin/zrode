...
const shouldLaunchElectronAfterPack = process.env.ZRODE_DESKTOP_DEV === "1";
...
export default defineConfig({
  run: {
    tasks: {
      ...
      dev: {
        command:
          "node scripts/build-preview-annotation-css.mjs && cross-env ZRODE_DESKTOP_DEV=1 vp pack --watch",
        dependsOn: ["t3#build"],
        cache: false,
      },
      "dev:bundle": {
