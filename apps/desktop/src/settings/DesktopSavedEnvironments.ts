import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@zrode/contracts";
import { fromLenientJson } from "@zrode/shared/schemaJson";
...
>()("zrode/desktop/SavedEnvironments") {}
