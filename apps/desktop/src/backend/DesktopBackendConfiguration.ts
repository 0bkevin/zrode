...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "ZRODE_NO_BROWSER",
  "ZRODE_HOST",
  "ZRODE_DESKTOP_WS_URL",
  "ZRODE_DESKTOP_LAN_ACCESS",
  "ZRODE_DESKTOP_LAN_HOST",
  "ZRODE_DESKTOP_HTTPS_ENDPOINTS",
  "ZRODE_TAILSCALE_SERVE",
  "ZRODE_TAILSCALE_SERVE_PORT",
] as const;
...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's ZRODE_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus ZRODE_HOME (dev-runner
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus ZRODE_HOME; pass it
