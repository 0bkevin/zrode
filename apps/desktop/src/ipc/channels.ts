...
export const OPEN_PANE_WINDOW_CHANNEL = "desktop:open-pane-window";
...
export const LOCAL_ENVIRONMENT_BOOTSTRAPS_UPDATED_CHANNEL =
  "desktop:local-environment-bootstraps-updated";
