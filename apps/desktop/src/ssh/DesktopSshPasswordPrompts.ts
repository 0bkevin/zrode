import type { DesktopSshPasswordPromptRequest } from "@zrode/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@zrode/contracts";
import type { SshPasswordRequest } from "@zrode/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "Zrode window is not available for SSH authentication.";
...
>()("zrode/desktop/SshPasswordPrompts") {}
