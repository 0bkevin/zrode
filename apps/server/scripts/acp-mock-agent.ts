...
const emitAskQuestion = process.env.ZRODE_ACP_EMIT_ASK_QUESTION === "1";
const emitXAiAskUserQuestion = process.env.ZRODE_ACP_EMIT_XAI_ASK_USER_QUESTION === "1";
const emitXAiPromptCompleteThenHang =
  process.env.ZRODE_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
const emitForeignSessionUpdates = process.env.ZRODE_ACP_EMIT_FOREIGN_SESSION_UPDATES === "1";
const hangPromptForever = process.env.ZRODE_ACP_HANG_PROMPT_FOREVER === "1";
const hangFirstPromptForever = process.env.ZRODE_ACP_HANG_FIRST_PROMPT_FOREVER === "1";
const emitLateUpdateAfterCancel = process.env.ZRODE_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL === "1";
...
const loadSessionDelayMs = Number(process.env.ZRODE_ACP_LOAD_SESSION_DELAY_MS ?? "5000");
const emitStaleXAiPromptCompleteBeforeSecondHang =
  process.env.ZRODE_ACP_EMIT_STALE_XAI_PROMPT_COMPLETE_BEFORE_SECOND_HANG === "1";
...
const promptDelayMs = Number(process.env.ZRODE_ACP_PROMPT_DELAY_MS ?? "0");
const permissionOptionIds = {
  allowOnce: process.env.ZRODE_ACP_ALLOW_ONCE_OPTION_ID ?? "allow-once",
  allowAlways: process.env.ZRODE_ACP_ALLOW_ALWAYS_OPTION_ID ?? "allow-always",
  rejectOnce: process.env.ZRODE_ACP_REJECT_ONCE_OPTION_ID ?? "reject-once",
};
