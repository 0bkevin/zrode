...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(gitCommonDir, `zrode-checkpoint-index-${randomUUID()}`);
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Zrode",
        GIT_AUTHOR_EMAIL: "zrode@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Zrode",
        GIT_COMMITTER_EMAIL: "zrode@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `zrode checkpoint ref=${input.checkpointRef}`;
