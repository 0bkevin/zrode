...
const EnvServerConfig = Config.all({
  ...
  otlpServiceName: Config.string("ZRODE_OTLP_SERVICE_NAME").pipe(Config.withDefault("t3-server")),
  mode: Config.schema(ServerConfig.RuntimeMode, "ZRODE_MODE").pipe(
    Config.option,
    Config.map(Option.getOrUndefined),
  ),
  ...
  t3Home: Config.string("ZRODE_HOME").pipe(Config.option, Config.map(Option.getOrUndefined)),
