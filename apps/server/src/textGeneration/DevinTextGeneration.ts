    ...
    Effect.gen(function* () {
      ...
      const promptResult = yield* Effect.gen(function* () {
        ...
        yield* applyDevinAcpModelSelection({
          ...
          availableModels: availableDevinModelsFromSessionSetup(started.sessionSetupResult),
            ...
            new TextGenerationError({
              ...
              detail:
                step === "set-session-model"
                  ...
                  : `Failed to set Devin ACP model config option "${configId ?? "model"}" for text generation.`,
              cause,
            }),
        });
