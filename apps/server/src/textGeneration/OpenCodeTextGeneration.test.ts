import { OpenCodeSettings, ProviderInstanceId } from "@zrode/contracts";
...
const OpenCodeTextGenerationTestLayer = Layer.succeed(
  ...
  Layer.provideMerge(
    ServerConfig.layerTest(process.cwd(), {
      prefix: "zrode-opencode-text-generation-test-",
    }),
  ),
...
const OpenCodeTextGenerationExistingServerTestLayer = Layer.succeed(
  ...
  Layer.provideMerge(
    ServerConfig.layerTest(process.cwd(), {
      prefix: "zrode-opencode-text-generation-existing-server-test-",
    }),
  ),
  Layer.provideMerge(NetService.layer),
  Layer.provideMerge(NodeServices.layer),
