...
export const makeGitHubCopilotTextGeneration = Effect.fn("makeGitHubCopilotTextGeneration")(
  function* (copilotSettings: GitHubCopilotSettings, environment: NodeJS.ProcessEnv = process.env) {
    ...
    const runGitHubCopilotJson = <S extends Schema.Top>({
      ...
      Effect.gen(function* () {
        const resolvedModel = resolveGitHubCopilotAcpModelId(modelSelection.model);
