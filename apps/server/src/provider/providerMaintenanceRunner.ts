...
>()("zrode/provider/ProviderMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Zrode could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Zrode still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
