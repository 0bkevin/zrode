...
import { isCommandAvailable, type CommandAvailabilityOptions } from "@zrode/shared/shell";
...
export { isCommandAvailable } from "@zrode/shared/shell";
...
export class ExternalLauncher extends Context.Service<ExternalLauncher, ExternalLauncherShape>()(
  "zrode/process/ExternalLauncher",
) {}
