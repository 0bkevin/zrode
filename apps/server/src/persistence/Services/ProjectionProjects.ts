 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@zrode/contracts";
...
>()("zrode/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
