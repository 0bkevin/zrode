...
export const CLIENT_SETTINGS_STORAGE_KEY = "zrode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "zrode:saved-environment-registry:v1";
