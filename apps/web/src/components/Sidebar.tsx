...
import { THREAD_DRAG_MIME, useThreadDragStore } from "../paneLayoutStore";
...
import { SidebarSplitViewSection } from "./SidebarSplitViewSection";
...
export const SidebarThreadRow = memo(function SidebarThreadRow(props: SidebarThreadRowProps) {
  ...
  // Dragging a row targets the split-pane drop zones in the thread view.
  const handleRowDragStart = useCallback(
    (event: React.DragEvent<HTMLElement>) => {
      ...
      useThreadDragStore.getState().startThreadDrag(threadKey);
    },
    [threadKey],
  );
  ...
  return (
    ...
    >
      <SidebarMenuSubButton
        ...
        draggable={!isMobile && renamingThreadKey !== threadKey}
