...
import { type TimestampFormat } from "@zrode/contracts/settings";
...
function stepStatusIcon(status: string): React.ReactNode {
  ...
  if (status === "inProgress") {
    return (
      <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-amber-500/15 text-amber-400">
              ...
              {activePlan.steps.map((step) => (
                <div
                  ...
                  className={cn(
                    ...
                    step.status === "inProgress" && "bg-amber-500/5",
