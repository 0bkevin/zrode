...
/** Official Kilo Code mark from `kilo-code-seeklogo.svg`. */
export const KiloCodeIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" className={className}>
...
export const DevinIcon: Icon = ({ className, ...props }) => (
  <svg
    ...
    className={cn("fill-[#0F0F0F] dark:fill-[#F5F5F5]", className)}
  >
    <path d="M23 48.6315V29.1756C23 28.3205 23.4562 27.5304 24.1967 27.1029L41.0414 17.3775C41.7819 16.95 42.6943 16.95 43.4348 17.3775L60.2796 27.1029C61.0201 27.5304 61.4762 28.3205 61.4762 29.1756V39.1118C61.5501 42.4135 63.2952 45.5981 66.3643 47.3701C69.4334 49.142 73.0639 49.061 75.9602 47.4741L84.5652 42.506C85.3057 42.0785 86.2181 42.0785 86.9586 42.506L103.803 52.2313C104.544 52.6589 105 53.449 105 54.304V73.7547C105 74.6097 104.544 75.3999 103.803 75.8274L86.9586 85.5527C86.2181 85.9802 85.3057 85.9803 84.5652 85.5527L76.0299 80.6248C73.1223 79.0011 69.4587 78.904 66.3651 80.69C63.296 82.462 61.551 85.6465 61.4771 88.9482V98.8817C61.4771 99.7368 61.0209 100.527 60.2804 100.954L43.4356 110.68C42.6951 111.107 41.7828 111.107 41.0423 110.68L24.1975 100.954C23.457 100.527 23.0008 99.7368 23.0008 98.8818V79.4311C23.0008 78.576 23.457 77.7859 24.1975 77.3584L41.0423 67.633C41.7828 67.2055 42.6951 67.2055 43.4356 67.633L52.0601 72.6124C54.953 74.1882 58.5732 74.2648 61.6349 72.4971C64.7285 70.7111 66.4762 67.4896 66.5238 64.1598C66.4499 60.858 64.7048 57.3321 61.6357 55.5602C58.5666 53.7882 54.9362 53.8692 52.0398 55.4561L43.3952 60.4753C42.6515 60.9071 41.7333 60.9067 40.99 60.4743L24.1898 50.7002C23.4532 50.2717 23 49.4837 23 48.6315Z" />
  </svg>
);
