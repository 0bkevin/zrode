...
export const ClientSettingsSchema = Schema.Struct({
  ...
  showNerdStats: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const KiloCodeSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("kilo").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Kilo Code CLI binary.",
...
export const GitHubCopilotSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom GitHub Copilot CLI home and state directory.",
        providerSettingsForm: {
          placeholder: "~/.copilot",
          clearWhenEmpty: "omit",
        },
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Zrode spawn the server when needed.",
        providerSettingsForm: {
...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    kilocode: KiloCodeSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  showNerdStats: Schema.optionalKey(Schema.Boolean),
