...
- review threads/comments/diffs: key by provider CR ID and head SHA/version when available; fetch on demand for Zrode Review
...
## Zrode Review Design Constraint
...
- The provider API includes the review operations needed by future Zrode Review work, even if they are capability-gated.
