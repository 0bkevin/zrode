...
This guide is for people who want to use more than one Claude setup in Zrode.
...
In Zrode Settings, your Claude provider can stay like this:
...
Add or edit a Claude provider in Zrode Settings:
...
Zrode does not need a special Claude Code Router provider. Treat the router as a Claude
environment.
...
2. Add or configure a Claude provider in Zrode.
