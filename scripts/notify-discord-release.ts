  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Zrode prerelease is available for nightly testers."
          : "A new Zrode latest release is available.",
...
).pipe(Command.withDescription("Post a Zrode release announcement to Discord."));
