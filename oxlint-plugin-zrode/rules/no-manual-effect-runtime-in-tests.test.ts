...
const rule = createOxlintRuleHarness("zrode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("zrode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("zrode/no-manual-effect-runtime-in-tests");
